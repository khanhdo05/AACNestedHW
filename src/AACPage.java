...
public interface AACPage {
	/**
	 * Adds the image location, text pairing to the page as either a pairing of items to be spoken or
	 ...
	 * the information that should be displayed or return text to be spoken.
	 * 
